...
const styles = StyleSheet.create({
  ...
  hudContainer: {justifyContent:"center", alignItems: "center", width:120, height:50, borderRadius: 5}
})
...
class HudView extends React.Component {
  ...
  _getFadeDuration() {
    return this.props.fadeDuration != null && this.props.fadeDuration >= 0 ? this.props.fadeDuration : 2000;
  }
  ...
  _getHudContainerStyles() {
    return [this.props.hudContainer ? this.props.hudContainer : styles.hudContainer, {opacity: this.state.fadeAnim}, {backgroundColor: this._getHudRgbaColor()}]
  }
