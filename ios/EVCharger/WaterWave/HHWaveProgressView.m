...
@interface HHWaveProgressView ()
@property (nonatomic, weak,readwrite) UIImageView *backgroundImageView;
@property (nonatomic, weak) HHWaterWaveView *waterWaveView;
...
@implementation HHWaveProgressView
...
{
    HHWaterWaveView *waterWaveView = [[HHWaterWaveView alloc]init];
