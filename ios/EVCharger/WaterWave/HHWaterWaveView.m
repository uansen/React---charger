...
//
#import "HHWaterWaveView.h"

@interface HHWaterWaveView ()
...
@implementation HHWaterWaveView{
...
- (void)setUp
{
    waterWaveHeight = self.frame.size.height/2;
    waterWaveWidth  = self.frame.size.width;
    _firstWaveColor = [UIColor colorWithRed:151/255.0 green:173/255.0 blue:249/255.0 alpha:1];
    _secondWaveColor = [UIColor colorWithRed:115/255.0f green:143/255.0f blue:254/255.0f alpha:1];
